...
| postgres.ephemeralStorage | object | `{}` | Configure ephemeralStorageLimit for proxy with units, `Mi`/`Gi` |
| postgres.ephemeralStorageLimit | object | `{}` | configure ephemeralStorageLimit for proxy with units, `Mi`/`Gi` |
